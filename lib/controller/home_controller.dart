  ...
  getData() async {
    ...
    if (StatusRequest.success == statusRequest) {
      if (response['status'] == "success") {
        ...
        titleHomeCard = announcementData[0]['announcement_title'];
        bodyHomeCard = announcementData[0]['announcement_body'];
        deliveryTime = announcementData[0]['announcement_deliverytime'];
